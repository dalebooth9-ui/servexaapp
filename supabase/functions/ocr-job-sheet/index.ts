        ...
        properties: {
          header: {
            ...
            properties: {
              ...
              customer_signed_name: { type: "string", description: "The PERSON's name printed or handwritten in the CUSTOMER signature block at the bottom of the form (NOT the company name, NOT the letterhead). ONLY return a value if the handwriting is clearly legible letter-by-letter. If the name is scribbled, illegible, ambiguous between two plausible readings (e.g. 'P. JONES' vs 'R. JONES', 'L' vs 'P'), partially cut off, or you would have to guess any character to complete it, you MUST return an EMPTY STRING and set field_confidence for this field <0.5. Do NOT invent a plausible-sounding name. Do NOT copy the header customer/company name into this field. A blank here is CORRECT when illegible — the office reviewer will fill it in manually. If the name IS clearly legible: HANDWRITING NOTE: 'L' has a horizontal base with NO loop; 'P' has a closed loop at top. Prefer 'L' unless a closed loop is clearly visible." },
