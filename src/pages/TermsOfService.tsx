      ...
      <div className="mx-auto max-w-3xl px-6 py-12">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground">
          ...
          <div className="border-t pt-6 space-y-3 text-xs text-muted-foreground">
            ...
            <p>Related documents: <a href="/privacy" className="text-primary hover:underline">Privacy Policy</a> · <a href="/dpa" className="text-primary hover:underline">Data Processing Agreement</a> · <a href="/aup" className="text-primary hover:underline">Acceptable Use Policy</a> · <a href="/sla" className="text-primary hover:underline">Service Level Agreement</a> · <a href="/cookies" className="text-primary hover:underline">Cookie Policy</a> · <a href="/fire-liability" className="text-primary hover:underline">Fire Protection Liability</a></p>
          </div>
        </div>
      </div>
    </div>
