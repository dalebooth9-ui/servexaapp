...
export const INDUSTRY_TEMPLATES: IndustryTemplate[] = [
  ...
  // ── Residential & Domestic Sprinklers (BS 9251:2021) ──
  {
    ...
    fields: [
      ...SITE_DETAIL_FIELDS,
      { id: "contract_number", label: "Contract Number", type: "text", section: "Site Details", required: false },
      { id: "service_frequency", label: "Service Frequency", type: "select", section: "Site Details", required: true, options: ["Annual", "Bi-Annual", "Quarterly"] },
      { id: "site_access_notes", label: "Site Access Notes (contact name, FOB access, caretaker, etc.)", type: "textarea", section: "Site Details", required: false },
      ...
      // Non-Compliance
      { id: "non_compliance_1", label: "Major Non-Compliance 1", type: "text", section: "Non-Compliance", required: false },
      { id: "non_compliance_1_ref", label: "BS 9251:2021 Clause Ref", type: "text", section: "Non-Compliance", required: false },
      { id: "non_compliance_2", label: "Major Non-Compliance 2", type: "text", section: "Non-Compliance", required: false },
      { id: "non_compliance_2_ref", label: "BS 9251:2021 Clause Ref", type: "text", section: "Non-Compliance", required: false },
      { id: "non_compliance_3", label: "Major Non-Compliance 3", type: "text", section: "Non-Compliance", required: false },
      { id: "non_compliance_3_ref", label: "BS 9251:2021 Clause Ref", type: "text", section: "Non-Compliance", required: false },
      { id: "additional_defects", label: "Additional Defects", type: "textarea", section: "Non-Compliance", required: false },
      { id: "engineer_comments", label: "Engineer's Comments", type: "textarea", section: "Non-Compliance", required: false },

      // Water Supplies Room
      { id: "wsr_location", label: "Room Location", type: "text", section: "Water Supplies Room", required: false },
      { id: "wsr_supply_type", label: "Supply Type", type: "select", section: "Water Supplies Room", required: false, options: ["Mains Direct", "Mains Boosted", "Tank Fed", "Gravity Tank"] },
      { id: "wsr_room_secure", label: "Is the room secure?", type: "checkbox", section: "Water Supplies Room", required: false, allow_notes: true, allow_na: true } as any,
      { id: "wsr_lighting", label: "Is lighting sufficient?", type: "checkbox", section: "Water Supplies Room", required: false, allow_notes: true, allow_na: true } as any,
      { id: "wsr_temperature", label: "Is the temperature maintained above 4°C?", type: "checkbox", section: "Water Supplies Room", required: false, allow_notes: true, allow_na: true } as any,
      ...
      // Storage Tank
      { id: "tank_present", label: "Is a storage tank present?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_location", label: "Tank Location", type: "text", section: "Storage Tank", required: false },
      { id: "tank_manufacturer", label: "Tank Manufacturer", type: "text", section: "Storage Tank", required: false },
      { id: "tank_type", label: "Tank Type", type: "text", section: "Storage Tank", required: false },
      { id: "tank_volume_ok", label: "Is tank capacity adequate and topped up?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_leaks", label: "Are there visible signs of leaks to tank or ancillaries?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_ladder", label: "Is the tank ladder present and safe?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_infill_iso", label: "Has the tank infill isolation valve been exercised and secured open?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_infill_float", label: "Has the tank infill float valve been exercised?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_suction_iso", label: "Has the tank suction isolation valve been exercised and secured open?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_drain_plug", label: "Is the tank drain valve fitted with a plug?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_low_water_signal", label: "Is the low water level signal received on panel?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_overflow", label: "Is the tank fitted with overflow and tell-tale?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_contents_gauge", label: "Is the tank contents gauge operating correctly?", type: "checkbox", section: "Storage Tank", required: false, allow_notes: true, allow_na: true } as any,
      { id: "tank_notes", label: "Storage Tank Notes", type: "textarea", section: "Storage Tank", required: false },

      // Fire Pump
      { id: "pump_present", label: "Is a booster/fire pump present?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_location", label: "Pump Location", type: "text", section: "Fire Pump", required: false },
      { id: "pump_manufacturer", label: "Pump Manufacturer", type: "text", section: "Fire Pump", required: false },
      { id: "pump_type", label: "Pump Type", type: "text", section: "Fire Pump", required: false },
      { id: "pump_leaks", label: "Are there visible signs of leaks on pump or ancillaries?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_suction_exercised", label: "Has the pump suction isolation valve been exercised?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_fault_suction_closed", label: "Was a fault signal received when the suction valve was closed?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_suction_secured", label: "Has the pump suction isolation valve been secured open?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_fire_signal", label: "Was a fire signal received when pump running in fire mode?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_suction_gauge", label: "Is the suction compound gauge functioning?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_fault_power_off", label: "Was a fault signal received when power was removed?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_delivery_exercised", label: "Has the pump delivery isolation valve been exercised?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_fault_delivery_closed", label: "Was a fault signal received when the delivery valve was closed?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_delivery_secured", label: "Has the pump delivery isolation valve been secured open?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_delivery_gauge", label: "Is the pump delivery pressure gauge functioning?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_annual_reset", label: "Has annual maintenance reset been carried out?", type: "checkbox", section: "Fire Pump", required: false, allow_notes: true, allow_na: true } as any,
      { id: "pump_plated_flow_req", label: "Fire Pump Plated Flow Required (L/min)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_plated_flow_ach", label: "Fire Pump Plated Flow Achieved (L/min)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_plated_pressure_req", label: "Fire Pump Plated Pressure Required (bar)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_plated_pressure_ach", label: "Fire Pump Plated Pressure Achieved (bar)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_favourable_flow_req", label: "Most Favourable Flow Required (L/min)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_favourable_flow_ach", label: "Most Favourable Flow Achieved (L/min)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_favourable_pressure_req", label: "Most Favourable Pressure Required (bar)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_favourable_pressure_ach", label: "Most Favourable Pressure Achieved (bar)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_remote_flow_req", label: "Most Remote Flow Required (L/min)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_remote_flow_ach", label: "Most Remote Flow Achieved (L/min)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_remote_pressure_req", label: "Most Remote Pressure Required (bar)", type: "number", section: "Fire Pump", required: false },
      { id: "pump_remote_pressure_ach", label: "Most Remote Pressure Achieved (bar)", type: "number", section: "Fire Pump", required: false },
      ...
      // Monitoring Panel
      { id: "panel_location", label: "Panel Location", type: "text", section: "Monitoring Panel", required: false },
      { id: "panel_manufacturer", label: "Panel Manufacturer", type: "text", section: "Monitoring Panel", required: false },
      { id: "panel_fire_indicated", label: "Are all fire signals clearly indicated on the panel?", type: "checkbox", section: "Monitoring Panel", required: false, allow_notes: true, allow_na: true } as any,
      ...
      // General Condition
      { id: "gc_leaks", label: "Are there visible signs of leaks attributable to the sprinkler system?", type: "checkbox", section: "General Condition", required: false, allow_notes: true, allow_na: true } as any,
      { id: "gc_leak_investigated", label: "If yes — has the leak been investigated?", type: "checkbox", section: "General Condition", required: false, allow_notes: true, allow_na: true } as any,
      { id: "gc_modifications", label: "Have there been modifications to the sprinkler system since last service?", type: "checkbox", section: "General Condition", required: false, allow_notes: true, allow_na: true } as any,
      { id: "gc_building_alterations", label: "Have there been material alterations to the building since last service?", type: "checkbox", section: "General Condition", required: false, allow_notes: true, allow_na: true } as any,
      { id: "gc_cover_plates", label: "Are sprinkler head cover plates damaged or contaminated?", type: "checkbox", section: "General Condition", required: false, allow_notes: true, allow_na: true } as any,
      { id: "gc_heads_visual", label: "Are sprinkler heads in satisfactory visual condition (not painted, obstructed, damaged or corroded)?", type: "checkbox", section: "General Condition", required: false, allow_notes: true, allow_na: true } as any,
      { id: "gc_heads_clearance", label: "Do heads have 500mm clear below?", type: "checkbox", section: "General Condition", required: false, allow_notes: true, allow_na: true } as any,
      { id: "gc_spare_heads", label: "Are spare heads and spanner on site?", type: "checkbox", section: "General Condition", required: false, allow_notes: true, allow_na: true } as any,
      { id: "gc_frost_protection", label: "Is frost protection adequate (lofts/garages)?", type: "checkbox", section: "General Condition", required: false, allow_notes: true, allow_na: true } as any,
      { id: "gc_notes", label: "General Condition Notes", type: "textarea", section: "General Condition", required: false },

      // Before Leaving Site
      { id: "bls_operational", label: "Has the system been left fully operational?", type: "checkbox", section: "Before Leaving Site", required: true, allow_notes: true, allow_na: true } as any,
      { id: "bls_panel_normal", label: "Has the monitoring panel been returned to normal?", type: "checkbox", section: "Before Leaving Site", required: true, allow_notes: true, allow_na: true } as any,
      { id: "bls_offsite_normal", label: "Has off-site monitoring been returned to normal?", type: "checkbox", section: "Before Leaving Site", required: true, allow_notes: true, allow_na: true } as any,
      { id: "bls_clean", label: "Has the site been left clean and tidy?", type: "checkbox", section: "Before Leaving Site", required: true, allow_notes: true, allow_na: true } as any,
      { id: "bls_log_completed", label: "Has the occupier/owner log book been updated?", type: "checkbox", section: "Before Leaving Site", required: true, allow_notes: true, allow_na: true } as any,
...
export default function IndustryTemplates() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters */}
      <div className="flex flex-col sm:flex-row gap-3" data-setup="template-library">
