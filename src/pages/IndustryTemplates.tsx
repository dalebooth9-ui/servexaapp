...
const INDUSTRY_TEMPLATES: IndustryTemplate[] = [
  ...
  {
    id: "dr-visual",
    name: "Dry Riser — Quarterly Visual Inspection",
    standard: "BS EN 9990",
    description: "Quarterly visual check of inlets, outlets, signage, and access as per BS EN 9990 maintenance schedule.",
    category: "dry_riser",
    fields: [
      { id: "site_name", label: "Site Name", type: "text", section: "Site Details", required: true },
      { id: "site_address", label: "Site Address", type: "textarea", section: "Site Details", required: true },
      ...
      { id: "date", label: "Inspection Date", type: "date", section: "Site Details", required: true },
      { id: "engineer", label: "Engineer Name", type: "text", section: "Site Details", required: true },
      { id: "inlet_condition", label: "Inlet Breeching Condition", type: "select", section: "Inlet", required: true, options: ["Satisfactory", "Unsatisfactory"] },
      { id: "inlet_caps_ok", label: "Inlet Caps Secure", type: "select", section: "Inlet", required: true, options: ["Yes", "No"] },
      { id: "outlet_condition", label: "Outlet Condition (all floors)", type: "select", section: "Outlets", required: true, options: ["Satisfactory", "Unsatisfactory"] },
      { id: "outlet_caps_ok", label: "Outlet Caps Secure (all floors)", type: "select", section: "Outlets", required: true, options: ["Yes", "No"] },
      { id: "signage_ok", label: "Signage Correct & Visible", type: "select", section: "General", required: true, options: ["Yes", "No"] },
      { id: "access_ok", label: "Access Clear", type: "select", section: "General", required: true, options: ["Yes", "No"] },
      { id: "physical_damage", label: "Evidence of Physical Damage", type: "select", section: "General", required: true, options: ["None", "Present"] },
