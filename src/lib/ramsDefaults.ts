...
const DEFAULTS: Record<RamsType, RamsDefaults> = {
  ...
  dry_riser_remedial: {
    descriptionOfWork:
      "Remedial repair works to dry riser systems including valve replacement, pipework repairs, cabinet rectification, hot works (grinding/cutting), and system restoration in accordance with BS 9990:2015 — Code of Practice for the Use of Dry Riser Systems.",
    sequenceOfOps: [
      ...COMMON_SEQUENCE,
      ...
      "Obtain a Hot Works Permit from the Principal Contractor / building management before any grinding, cutting, or welding operations. Confirm fire watch arrangements.",
    ],
    taskSpecificOps: [
      ...
      "Where pipework cutting or grinding is required: obtain Hot Works Permit, clear combustible materials within a 3-metre radius, position fire extinguisher at point of works, and post a fire watch for a minimum of 60 minutes after hot works cease.",
      "Ensure angle grinder is fitted with correct disc for material (metal cutting/grinding). Inspect disc for damage before use. Operate at rated speed only.",
      "Operatives using grinders or performing hot works must wear face shield (EN166), leather gauntlet gloves, and fire-resistant overalls in addition to standard PPE.",
      "Sparks and swarf to be controlled using welding blankets or spark guards to protect adjacent surfaces, cables, and seals.",
    ...
    plantAndEquipment: [
      ...
      "Welding blankets / spark guards",
      "Fire extinguisher (dry powder or CO2) — at point of hot works",
      "Replacement valves, caps, chains, and fittings",
    ],
    significantRisks: [
      "Water discharge / flooding", "High pressure water", "Working at height",
      "Manual handling (pipe and valves)", "Slips/trips/falls (wet floors)", "Lone working",
      "Hot works / fire risk (grinding, cutting)", "Flying sparks and swarf", "Disc failure / ejection (angle grinder)",
    ],
    specialTraining: "All operatives hold current CSCS cards. Operatives performing hot works must be trained and competent in angle grinder use and hot works procedures.",
    ppeItems: [
      ...COMMON_PPE,
      "Face Shield EN166 (for grinding/hot works)",
      "Leather Gauntlet Gloves (for grinding/hot works)",
      "Fire-Resistant Overalls (for grinding/hot works)",
    ],
    riskRows: [
      ...
      ["Grinding / pipe cutting (hot works)","Fire risk from sparks igniting combustibles","Fire breaking out in riser cupboard or adjacent areas. Structural damage. Occupant evacuation.","4","6","24","Hot Works Permit required before starting. Clear all combustibles within 3 m radius. Use welding blankets/spark guards. Fire extinguisher at point of works. 60-minute fire watch after works cease.","2","4","8",""],
      ["Grinding / pipe cutting (hot works)","Angle grinder disc failure / ejection","Disc fragmentation causing serious lacerations or eye injuries to operative and bystanders.","3","6","18","Inspect disc before fitting. Never exceed rated speed. Use guard at all times. Bystanders to stand outside exclusion zone. Operative to wear face shield and leather gauntlets.","1","5","5",""],
      ["Grinding / pipe cutting (hot works)","Flying sparks and metal swarf","Eye injury to operative or bystanders. Burns to skin or clothing. Ignition of nearby materials.","3","5","15","Full face shield mandatory. Leather gauntlet gloves and fire-resistant overalls. Spark guards positioned to contain swarf. Exclusion zone enforced.","2","3","6",""],
      ...COMMON_RISK_ROWS,
    ],
  },
