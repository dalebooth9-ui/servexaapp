...
import { LayoutDashboard, Briefcase, Users, Settings, LogOut, Menu, X, CalendarDays, Building2, FileText, MapPin, Package, Shield, Library, MessageCircle, BarChart2, TrendingUp, GripVertical, BookOpen, ListChecks, ClipboardList, ChevronDown, Pin, PinOff, Palmtree, ClipboardCheck } from "lucide-react";
...
{ to: "/audits", label: "Audits", icon: ClipboardCheck, section: "more" },
